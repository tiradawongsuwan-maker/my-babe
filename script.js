...
function checkAnswer(index) {
  ...
  if (index === q.answer) {
    ...
    resultEl.innerText = "ยังไม่ใช่น้า 😝";
...
====================== */
const gifts = [
  { text: "💌 รักเธอที่สุดในโลกเลยนะ", img: "gift1.jpg" },
  { text: "🍰 ไว้ไปกินของอร่อยด้วยกัน", img: "gift2.jpg" },
  { text: "🎬 ดูหนังด้วยกันทุกอาทิตย์", img: "gift3.jpg" },
  { text: "📸 จะมีรูปคู่เพิ่มอีกเยอะเลย", img: "gift4.jpg" },
  { text: "💍 อนาคตมีเราสองคน", img: "gift5.jpg" }
];
...
function showFinal() {
  ...
  choicesEl.innerHTML = `
    <p>เธอเก่งมากที่ผ่านทุกข้อ 💕<br>เลือกเปิดได้ทีละกล่องนะ</p>
...
ไม่ว่าจะวันไหน เค้าก็ยังเลือกเธอ

ขอให้ปีนี้
เป็นปีที่มีแต่รอยยิ้ม
และมีเค้าอยู่ข้าง ๆ ตลอดไป 🥰
`;
